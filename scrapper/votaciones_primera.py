...
class DataScrapper:
    ...
    def scrap(self,intento = 0):
        try:
            ...
            provoste = self.driver.find_element_by_xpath('//*[@id="basic-table"]/table/tbody[1]/tr[8]/td[3]/small/span').text
            sichel = self.driver.find_element_by_xpath(  '//*[@id="basic-table"]/table/tbody[1]/tr[11]/td[3]/small/span').text
            artes = self.driver.find_element_by_xpath(   '//*[@id="basic-table"]/table/tbody[1]/tr[14]/td[3]/small/span').text
            meo = self.driver.find_element_by_xpath(     '//*[@id="basic-table"]/table/tbody[1]/tr[17]/td[3]/small/span').text
            parisi = self.driver.find_element_by_xpath(  '//*[@id="basic-table"]/table/tbody[1]/tr[20]/td[3]/small/span').text 
            ...
            valores = [boric,kast,provoste,sichel,artes,meo,parisi,nulos,blanco]
...
time.sleep(1)
#driver.get("http://pv.servelelecciones.cl/")
...
driver.close()
tabla = pd.DataFrame(votaciones,columns = ["region","circ_sen","distrito","comuna","circ_elec","local_vot","mesa","boric","kast","provoste","sichel","artes","meo","parisi","nulos","blanco"])
filename = "votos_1ra_{}-{}.xlsx".format(inicio,fin)
